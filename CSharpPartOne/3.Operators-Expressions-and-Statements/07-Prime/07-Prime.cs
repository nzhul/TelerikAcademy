...
// за да бъзе Prime едно число то трябва да при деление с друго число винати да дава остатък. Тоест - всяко число, което не дава остатък при деление по модул - НЕ Е PRIME.!
