        ...
        public static class PhonebookEntryPoint
        {
            ...
            static void Main()
            {
                while (true)
                {
                    ...
                    if ((k.StartsWith("AddPhone")) && (strings.Length >= 2)) { Cmd("AddPhone", strings); }
                    else if ((k == "ChangePhone") && (strings.Length == 2)) { Cmd("ChangePhone", strings); }
                    else if ((k == "List") && (strings.Length == 2)) { Cmd("List", strings); }
